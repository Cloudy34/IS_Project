    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container">
              <div class="small text-center text-muted">Copyright © 2023 - Digital Menu & Ordering System </div>
              <div class="small text-center text-muted"><a href="tel:+254792650995">Contact</a></div>
              <div class="small text-center text-muted"><a href="mailto:Jenykumar.patel@Strathmore.edu"  >Feedback</a></div>
